            ...
            <div class="bg-white shadow overflow-hidden border-b border-gray-200 sm:rounded-lg" style="margin:100px">
                ...
                <div class="flex mb-4">
                    <div class="flex items-center border rounded-md border-gray-300" style="margin-left: 20px;">
                        <select class="px-2 py-1 border border-transparent focus:outline-none focus:ring-2 focus:ring-blue-400">
                            <option value="option1">Option 1</option>
                            <option value="option2">Option 2</option>
                            <option value="option3">Option 3</option>
                        </select>
                        <input type="text" class="px-2 py-1 border border-transparent focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Search...">
