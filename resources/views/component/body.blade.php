    ...
    <div class="bg-gray-200 text-white p-6 border-black">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full">
                ...
                <tbody>
                    <tr>
                        <td class="py-2 px-4 border text-black bg-white"></td>
                        <td class="py-2 px-4 border text-black bg-white">{{ $totalAlert }} </td>
                        <td class="py-2 px-4 border text-black bg-white"> dfdf</td>
                        <td class="py-2 px-4 border text-black  bg-white">sdfs </td>
